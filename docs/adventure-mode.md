...
Each attempt to advance will cost 1 ticket and the ticket WILL be consumed even if you fail the stage. A victory will result in advancement and being rewarded with the resource for that stage.

Players start with 3 tickets and will get 1 ticket per 24 hours and NO NEW tickets will be earned once the cap (3/3) is reached.
...
First Gate: At Stage 3 with a 6 hours timer.

Second Gate: At Stage 6 with a 12 hours timer.

Third Gate: At Stage 13 with a 24 hours timer.

Fourth Gate: At stage 20 with a 24hours timer.

Fifth Gate: At stage 28 with a 24 hours timer.

Sixth Gate: At stage 35 with a 48 hours timer.

The hero is unlocked after this gate.

Seventh Gate: At stage 42 with a 48 hours timer.

Eighth Gate: At stage 50 with a 72 hours timer.
